...
purple='\e[35m'
hong='[1;95m'
thanh_xau=trang+'~'+red+'['+vang+'vL'+red+'] '+trang+'➩ '+luc
thanh_dep=trang+'~'+red+'['+luc+'vL'+red+'] '+trang+'➩ '+luc
...
def hoanthanh(dem, id, type, msg, xu):
	...
	print(f'\033[1;36m[{dem}\033[1;36m]\033[1;36m|\033[1;36m{time}\033[1;36m| \033[1;36m{type} \033[1;36m| \033[1;33m{uid} \033[1;36m| \033[1;32m{msg} \033[1;36m| \033[1;33m{xu} \033[1;36m|')
def error(id, type):
	time=datetime.now().strftime("%H:%M:%S")
	uid = id.split('_')[1] if '_' in id else id
	print(f'\033[1;36mđang hết nhiệm vụ đợi tìm nhiệm vụ nhé', end = '\r'); sleep(2); print('                                                   ', end = '\r')
...
def Nhap_Cookie():
	...
	while True:
		i += 1
		cookie = input(f' \033[1;37m<vL> \033[1;32mNhập Cookie Facebook Thứ: \033[1;33m{i}: ')
		if cookie == '' and i > 1:
			break
		...
		if name != 0:
			ten = name[0]
			print('\033[1;36m────────────────────────────────────────────────────────────')
			print(f' \033[1;37m<vL> \033[1;32mTên Facebook: {ten}')
...
def main():
	...
	while True:
		if os.path.exists('configtds.txt'):
			...
			data = tds.main()
			try:
				print(' \033[1;37m<vL> \033[1;32mNhập [\033[1;33m1\033[1;32m] Giữ Lại Tài Khoản '+ data['user'] )
				print(' \033[1;37m<vL> \033[1;32mNhập [\033[1;33m2\033[1;32m] Nhập Access_Token TDS Mới')
				chon = input(' \033[1;37m<vL> \033[1;32mVui Lòng Nhập :\033[1;33m ')
				if chon == '2':
					os.remove('configtds.txt')
				elif chon == '1':
					pass
				else:
					print('Lựa chọn không xác định !!!');vanlongz(14)
					continue 
			except:
				os.remove('configtds.txt')
		if not os.path.exists('configtds.txt'):
			token = input(' \033[1;37m<vL> \033[1;32mNhập Access_Token TDS:\033[1;33m ')
	...
	while True:
		if os.path.exists('Cookie_FB.txt'):
			print(' \033[1;37m<vL> \033[1;32mNhập [\033[1;33m1\033[1;32m] Sử Dụng Cookie Facebook Đã Lưu ')
			print(' \033[1;37m<vL> \033[1;32mNhập [\033[1;33m2\033[1;32m] Nhập Cookie Facebook Mới')
			chon = input(' \033[1;37m<vL> \033[1;32mVui Lòng Nhập:\033[1;33m ')
			if chon == '1':
				...
				os.remove('Cookie_FB.txt'); vanlongz(14)
			else:
				print('Lựa Chọn Không Xác Định.'); vanlongz(14); continue
		if not os.path.exists('Cookie_FB.txt'):
			...
			break
	banner()
	print(f' \033[1;37m<vL> \033[1;32mTên Tài Khoản: {user} ')
	print(f' \033[1;37m<vL> \033[1;32mXu Hiện Tại: {xu}')
	print(f' \033[1;37m<vL> \033[1;32mXu Bị Phạt: {xudie} ')
	print(f' \033[1;37m<vL> \033[1;32mSố Cookie: {len(list_cookie)} ')
	print('\033[1;36m────────────────────────────────────────────────────────────')
	print('\033[1;30mNhập số <>[1]<> Nhiệm Vụ Like 400xu')
	print('\033[1;30mNhập số <>[2]<> Nhiệm Vụ Like 2 600xu')
	print('\033[1;30mNhập số <>[3]<> Nhiệm Vụ Like 3 150xu')
	print('\033[1;30mNhập số <>[4]<> Nhiệm Vụ Comment')
	print('\033[1;30mNhập số <>[5]<> Nhiệm Vụ Share')
	print('\033[1;30mNhập số <>[6]<> Nhiệm Vụ Cảm xúc')
	print('\033[1;30mNhập số <>[7]<> Nhiệm Vụ Follow')
	print('\033[1;30mNhập số <>[8]<> Nhiệm Vụ Like Page')
	print('\033[1;30mNhập số <>[9]<> Nhiệm Vụ Cảm xúc comment')
	print('\033[1;30mNhập số <>[10]<> Nhiệm Vụ Tham gia group')
	print('\033[1;30mNhập số <>[11]<> Nhiệm Vụ gộp lại của số 123')
	print('\033[1;36m────────────────────────────────────────────────────────────')
	print(' \033[1;37m<vL> \033[1;32mCó Thể Chọn Nhiều Nhiệm Vụ (Ví Dụ 123...)')
	nhiemvu = input (' \033[1;37m<vL> \033[1;32mNhập Số Để Chạy Nhiệm Vụ: ')
	delaymin = int(input(' \033[1;37m<vL> \033[1;32mNhập Delay Min: '))
	delaymax = int(input(' \033[1;37m<vL> \033[1;32mNhập Delay Max: '))
	print(' \033[1;37m<vL> \033[1;32mSau ____ Nhiệm Vụ Thì Kích Hoạt Chống Block.',end='\r')
	nvblock = int(input(' \033[1;37m<vL> \033[1;32mSau '))
	print(f' \033[1;37m<vL> \033[1;32mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi ____ Giây       ',end='\r')
	delaybl = int(input(f' \033[1;37m<vL> \033[1;32mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi '))
	doinick = int(input(' \033[1;37m<vL> \033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick: '))
	print('\033[1;36m────────────────────────────────────────────────────────────')
	while True:
		...
		for cookie in list_cookie:
			...
			while True:
				...
				nvlike2 = 2 if '2' in nhiemvu else 0
				nvlike3 = 3 if '3' in nhiemvu else 0
				nvcmt = 4 if '4' in nhiemvu else 0
				nvshare = 5 if '5' in nhiemvu else 0
				nvcx = 6 if '6' in nhiemvu else 0
				nvfollow = 7 if '7' in nhiemvu else 0
				nvpage = 8 if '8' in nhiemvu else 0
				nvcxcmt = 9 if '9' in nhiemvu else 0
				nvgroup = 10 if '10' in nhiemvu else 0
			######
				...
				if nvlike == 1:
					...
					if listlike == False:
						...
						if listlike.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Like, COUNTDOWN: {str(round(coun, 3))}              ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							...
							for x in listlike:
								...
								if like == False:
									...
									try:
										...
										loilike = 0
										if dem % doinick == 0:
											vanlongz(14); print(f'Số Xu Hiện Tại: {xu} | Số Tài Khoản Facebook {len(list_cookie)}'); vanlongz(14); vanlong = 1; break
										if dem % nvblock == 0:
											chongblock(delaybl)
										else:
				...
				if nvlike2 == 2:
					...
					if listlike2 == False:
						...
						if listlike2.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Like 2, COUNTDOWN: {str(round(coun, 3))}                 ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
						...
						if len(listlike2) == 0:
							...
							for x in listlike2:
								...
								if loilike >= 5:
									name = fb.get_thongtin()
									if name == 0:
										print(f'  Cookie Tài Khoản FB {ten} Đã Bị Out !!!                ')
									else:
										print(f' Tài Khoản FB {ten} Đã Bị Block Like !!!					')
									list_cookie.remove(cookie)
									vanlong = 1
									break
				if vanlong == 1:
				...
				if nvlike3 == 3:
					...
					if listlike3 == False:
						...
						if listlike3.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Like 3, COUNTDOWN: {str(round(coun, 3))}                 ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvcmt == 4:
					...
					if listcmt == False:
						...
						if listcmt.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Comment, COUNTDOWN: {str(round(coun, 3))}               ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvshare == 5:
					...
					if listshare == False:
						...
						if listshare.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Share, COUNTDOWN: {str(round(coun, 3))}                ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							...
							for x in listshare:
								...
								if loishare >= 5:
									...
									if name == 0:
										...
										print(f' Tài Khoản FB {ten} Đã Bị Block Share !!!					')
									list_cookie.remove(cookie)
									vanlong = 1
									break
				...
				if nvcx == 6:
					...
					if listcx == False:
						...
						if listcx.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Cảm Xúc, COUNTDOWN: {str(round(coun, 3))}                 ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvfollow == 7:
					...
					if listfollow == False:
						...
						if listfollow.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Follow, COUNTDOWN: {str(round(coun, 3))}                     ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvpage == 8:
					...
					if listpage == False:
						...
						if listpage.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Page, COUNTDOWN: {str(round(coun, 3))}                         ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvcxcmt == 9:
					...
					if listcxcmt == False:
						...
						if listcxcmt.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Cảm Xúc Comment, COUNTDOWN: {str(round(coun, 3))}                   ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
				...
				if nvgroup == 10:
					...
					if listgroup == False:
						...
						if listgroup.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
							...
							print(f'Đang tìm Nhiệm Vụ Group, COUNTDOWN: {str(round(coun, 3))}               ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
						else:
							print(listlike.json()['error'] , end ='\r')
						nvgroup = 0
						listgroup = []
