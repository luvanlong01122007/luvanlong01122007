...
async def main(post_id, token_dict, total_shares, chống_block1, chống_block):
...
if __name__ == "__main__":
    ...
    cookie = Write.Input(f"Nhập cút Ki: ", Colors.green_to_blue, interval=0.005)
    ...
    try:
        asyncio.run(main(post_id, token_dict, total_shares, chống_block1, chống_block))
    except Exception as e:
